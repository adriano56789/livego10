...
export const GIFTS: Gift[] = [
    ...
    { id: 'gift-203', name: 'Controle', price: 99, icon: '🎮', category: 'Jogos' },
    { id: 'gift-204', name: 'Joystick', price: 199, icon: '🕹️', category: 'Jogos' },
    { id: 'gift-205', name: 'Fantasma', price: 299, icon: '👻', category: 'Jogos' },
    { id: 'gift-206', name: 'Espadas', price: 399, icon: '⚔️', category: 'Jogos' },
    { id: 'gift-207', name: 'Nave', price: 499, icon: '👾', category: 'Jogos' },
    { id: 'gift-208', name: 'Caixa ?', price: 599, icon: '❓', category: 'Jogos' },
    { id: 'gift-209', name: 'Foguete G', price: 899, icon: '🚀', category: 'Jogos' },
    { id: 'gift-210', name: 'Bomba', price: 999, icon: '💣', category: 'Jogos', triggersAutoFollow: true }
];
