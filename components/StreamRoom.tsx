...
const StreamRoom: React.FC<StreamRoomProps> = ({ streamer, onRequestEndStream, onLeaveStreamView, onStartPKBattle, onViewProfile, currentUser, onOpenWallet, onFollowUser, onOpenPrivateChat, onOpenPrivateInviteModal, setActiveScreen, onOpenPKTimerSettings, onOpenFans, onOpenFriendRequests, updateUser, liveSession, updateLiveSession, logLiveEvent, onStreamUpdate, addToast, followingUsers, streamers, onSelectStream, onOpenVIPCenter, onOpenFanClubMembers }) => {
    ...
    const streamerUser: User = useMemo(() => ({
        ...
        name: streamer.name,
        avatarUrl: streamer.avatar || `https://picsum.photos/seed/${streamer.id}/200`,
        ...
        bio: streamer.description || 'Amante de streams!',
        obras: [],
        curtidas: [],
        ownedFrames: [],
        activeFrameId: null,
    ...
    useEffect(() => {
        ...
        const handleNewGift = (payload: GiftSendPayload) => {
            ...
            // Do not call refreshOnlineUsers automatically.
            setGiftAnimationQueue(prev => [...prev, payload]);
        };
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-col items-end space-y-2">
                        <div className="flex items-center space-x-2">
                            ...
                            <button onClick={handleViewOnlineUsers} className="flex items-center bg-black/40 rounded-full px-2.5 py-1.5 space-x-1 text-sm cursor-pointer">
                    ...
                    <div className="space-y-2 mt-auto">
                         {messages.map((msg) => {
                            if (msg.type === 'fan_entry' && msg.fullUser) {
                                return <FanClubEntryMessage key={msg.id} user={msg.fullUser} />;
                            }
                            ...
                            if (msg.type === 'chat' && msg.fullUser) {
                                const chatUser = msg.fullUser;
